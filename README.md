...
| <a name="input_cloudtrail_bucket_region"></a> [cloudtrail\_bucket\_region](#input\_cloudtrail\_bucket\_region) | The region where the cloudtrail bucket will be created or is located, required if cloudtrail is enabled | `string` | `""` | no |
